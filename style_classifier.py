...
class Classifier(object):
    ...
    def _build_model(self):
        ...
        self.origin_test = tf.compat.v1.placeholder(tf.float32,
        ...
        # test midi
        self.test_midi = tf.compat.v1.placeholder(tf.float32,
                                                  [None, self.time_step, self.pitch_range, self.input_c_dim])
    ...
    def train(self, args):
        ...
        # log path
        log_dir = os.path.join(self.log_dir, 'classifier_{}2{}_{}_{}'.format(self.dataset_A_dir, self.dataset_B_dir,
                                                                             self.now_datetime,
                                                                             str(self.sigma_c)))
    ...
    def test(self, args):
        ...
        for idx in range(len(sample_files)):
            ...
            if args.which_direction == 'AtoB':
                ...
                path_transfer = os.path.join(test_dir_mid,
                                             '{}_transfer_{}.mid'.format(idx + 1, test_result_transfer[0][0]))
                ...
                path_transfer = os.path.join(test_dir_mid,
                                             '{}_transfer_{}.mid'.format(idx + 1, test_result_transfer[0][1]))
